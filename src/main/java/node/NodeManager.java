...
public class NodeManager {
    ...
    public NodeManager(ClusterConfiguration clusterConfiguration) throws IOException {
        ...
        Optional<NodeInfo> nodeInfo = clusterConfiguration
                ...
                .findAny();
        this.kvNode = new KVNode(clusterConfiguration.getCurrentNodeId(), nodeInfo.get().getPort(), new PersistedKVStore<>());
    }
